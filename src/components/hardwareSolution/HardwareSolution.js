    ...
    <div className="app__HardwareSolution">
      ...
      <div className="app__HardwareSolution--info">
        ...
        <p className="app__HardwareSolution__paragraph">
          ...
          Vestibulum ligula nibh, semper id vestibulum et, dapibus et odio. Sed
          in sem et lectus luctus cursus nec in nunc. Suspendisse cursus erat
          faucibus imperdiet suscipit. Pellentesque ut tortor ut justo
          sollicitudin condimentum et vitae purus. Phasellus tristique porttitor
          diam, sit amet facilisis sem sagittis at. Duis bibendum feugiat libero
          lacinia convallis. Nullam sagittis massa sed dolor elementum
          tristique. Suspendisse in metus libero. Aenean ullamcorper vestibulum
          quam id sodales.
        </p>
